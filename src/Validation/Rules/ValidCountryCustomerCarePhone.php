...
class ValidCountryCustomerCarePhone implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        if (! $this->rules->isValidCustomerCarePhone($value)) {
            $fail($this->rules->customerCarePhoneValidationMessage());
        }
    }
